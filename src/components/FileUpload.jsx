...
const FileUpload = () => {
  return (
    <div className="mt-4 mb-4 mr-4 p-5 pb-20 bg-foreground text-text rounded-2xl bg-[radial-gradient(circle,_rgba(255,255,255,0.05)_1px,_transparent_1px)] [background-size:30px_30px]">
      {/* Header */}
        ...
        {files.map((file, index) => (
          ...
          >
            ...
            <div className="flex items-center gap-2 text-sm text-text-secondary">
              ...
              <X className="w-4 h-4 cursor-pointer text-text-secondary" />
            </div>
          </div>
        ))}
      </div>
